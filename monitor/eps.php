...
<body class="hold-transition sidebar-mini sidebar-collapse">
  <div class="wrapper">
        ...
        <a href="painel.php" class="nav-link">
          ...
          <li class="nav-item" id="li-user">
            ...
            <li class="nav-item" id="li-eps">
              <!--<script type="text/javascript"> var $skill="<?php echo $skill; ?>"; console.log("Skill", $skill)</script>-->
              <a href="eps.php" class="nav-link active">
    ...
    <div class="content-wrapper">
      ...
      <div>
        <button type="button" class="btn btn-block btn-primary" onclick="javascript:NovoUsuario();">Nova EPS</button>
      </div>
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">EPS cadastradas</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          ...
          <form>
            <div class="form-row">
              <div class="form-group col-md-6">
                <label class="col-form-label">Sigla Cliente:</label>
                <input id="txtSigla" type="text" class="form-control" maxlenght="45" placeholder="Sigla">
              </div>
              <div class="form-group col-md-6">
                <label class="col-form-label">Nome:</label>
                <input id="txtDescricao" type="text" class="form-control" maxlenght="100" placeholder="Nome">
              </div>
            </div>
          </form>
        </div>
  ...
  <script>
    ...
    function Logger(){
      var siglaNova = document.getElementById('txtSigla').value;
