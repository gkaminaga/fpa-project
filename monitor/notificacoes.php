...
<div class="container-fluid">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Central de Notificações</h3>
      <h5>Próximas consultas (PRS)</h5>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
  function Listar() {
    ...
    var nextdates = new Date(result);
    var dia = String(nextdates.getDate()).padStart(2, '0');
    var mes = String(nextdates.getMonth() + 1).padStart(2, '0'); //January is 0!
    var ano = nextdates.getFullYear();


    today = yyyy + '-' + mm + '-' + dd;
    console.log(today);
    var todaywithfivedays = ano + '-' + mes + '-' + dia;
    console.log(todaywithfivedays);
    ...
    $($("#dash1").DataTable({
        dom: "Bfrtip",
        ajax: {
            url: "../phpwsdb/notificacoes.php?data_inicial=" + today + "&data_final=" + todaywithfivedays,
            type: 'GET'
            //body: form
        },
