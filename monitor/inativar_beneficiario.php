  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button id="submitButton" type="button" class="btn btn-success" onclick="Salvar(); SalvarHistorico();">Salvar</button>
      </div>
    </div>
  </div>
</div>
...
<script>
  ...
  function SalvarHistorico() {
    ...
    const data_evento = $("#dataSaida").val();
    const motivo = $("#motivoSaida").val();
    const obito = $("#ddlObito").val();
    const data_obito = $("#dataObito").val();
    ...
    $.ajax({
      url: "../phpwsdb/adicionar_historico.php",
      data: jsonData,
      type: 'POST',
    })
