...
class api_sqlsrv
{
	...
	function lista_unidade()
	{
		...
		$query = "SELECT id, nome_unidade, contato_unidade, endereco_unidade, ativo FROM unidade";
	...
	function lista_origem()
	{
		$confdb = json_decode(file_get_contents('configuration.json'), TRUE);

		$db = new mysqli($confdb['host_sqlsrv'], $confdb['user_sqlsrv'], $confdb['password_sqlsrv'], $confdb['database_sqlsrv']);

		$query = "SELECT id, sigla_origem, nome_origem, contato_origem, endereco_origem FROM origem";
